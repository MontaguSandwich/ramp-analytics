...
/**
 * Categories tab — top-level taxonomy of the venue types we track. Each card uses the
 * canonical category name from CATEGORY_LABEL + a short description and a KYC note.
 * Click → pre-filtered Overview.
 */
    ...
    <div className="container">
      ...
      <div className="category-grid">
        {CATEGORIES.map((c) => {
          ...
          const title = CATEGORY_LABEL[c.slug] ?? c.slug;
          const venueNames =
          ...
          const inner = (
            <>
              <div className="category-card-head">
                <h3 className={`category-card-title cat-${c.slug}`}>{title}</h3>
