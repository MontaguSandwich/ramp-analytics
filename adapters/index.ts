...
import revolut_ramp from './revolut_ramp.ts';
...
// revolut (first RTPN venue) + revolut_ramp (Licensed Ramp) added 2026-07-22.
export const adapters: Adapter[] = [zkp2p, ramp_network, binance_p2p, revolut_ramp, revolut];
